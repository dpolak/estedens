...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$est__description = get_bloginfo( 'description', 'display' );
			if ( $est__description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $est__description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
